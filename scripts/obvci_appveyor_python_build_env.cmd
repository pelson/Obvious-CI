...
::
:: 32 bit builds have Visual Studio's vc\vcvarsall.bat executed.
::
...
IF "%TARGET_ARCH%"=="x64" (
    ...
    ECHO Configuring Visual Studio for 32 bit architecture
    "%VISUAL_STUDIO_ROOT:"=% %VISUAL_STUDIO_VERSION:"=%\vc\vcvarsall.bat" x86
    ECHO Executing: %COMMAND_TO_RUN%
    call %COMMAND_TO_RUN% || EXIT 1
)
